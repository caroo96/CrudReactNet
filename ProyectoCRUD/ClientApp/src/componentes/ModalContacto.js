...
import { Button, ModalFooter, Input, Label, Modal, ModalHeader, ModalBody, Form, FormGroup } from "reactstrap";
...
const ModalContacto = ({ mostrarModal, setMostrarModal, guardarContacto, editar, setEditar, editarContacto }) => {
    ...
    const enviarDatos = () => {
        if (contacto.idContacto == 0) {
            ...
            editarContacto(contacto); // Aquí se pasa el parámetro `contacto`
        }
    ...
    return (
        ...
        <Modal isOpen={mostrarModal}>
            ...
            <ModalFooter>
                ...
                <Button color="danger" size="" onClick={cerrarModal}>Cerrar</Button>
